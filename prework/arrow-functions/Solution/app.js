...
//    To a global Object which is the window in this case.
// 3. Explain why "this" is different when an arrow function is used.
//   In the Regular Function (this) keyword represent the object that called the function,
//   As we saw in this case it was the Student object.
//   On the other hand (this) keyword in the arrow function represents the object that defined the arrow function.
//   and here the arrow function is defined by the window object, that's why the console.log printed the window object.
